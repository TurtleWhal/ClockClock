...
struct MotorControl_t {
    ...
    uint8_t acceleration = 10; // Acceleration in steps per second squared
    uint16_t speed = 100; // Speed in steps per second
    ...
    uint16_t time = 5000; // Time in milliseconds to reach the target position
};
